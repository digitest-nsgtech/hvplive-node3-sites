...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.home\.sillamaegymn\.edu\.ee$',
  '^home\.sillamaegymn\.edu\.ee$',
];

$base_url = 'https://home.sillamaegymn.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/home.sillamaegymn.edu.ee/files';
$settings['file_private_path'] = 'sites/home.sillamaegymn.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/home.sillamaegymn.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'home_sillamaegymn_edu_ee_db',
  'username' => 'home_sillamaegymn_edu_ee_user',
  'password' => 'emIN8BNK4xrC8/1K7bVtyIlWsFke3Y+/',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
