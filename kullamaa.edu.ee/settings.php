...
$base_url = 'https://kullamaa.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/kullamaa.edu.ee/files';
$settings['file_private_path'] = 'sites/kullamaa.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/kullamaa.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'kullamaa_edu_ee_db',
  'username' => 'kullamaa_edu_ee_user',
  'password' => 'ZtiFCByu7mZjykI47zATWQK0MLyJE7uh',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
