...
$base_url = 'https://tyripk.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/tyripk.ee/files';
$settings['file_private_path'] = 'sites/tyripk.ee/privatefiles';
$settings['file_temp_path'] = 'sites/tyripk.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'tyripk_ee_db',
  'username' => 'tyripk_ee_user',
  'password' => 'yedN6zeubjFerMaLkrJQaS0921kS6KXv',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
