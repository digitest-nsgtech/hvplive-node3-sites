...
$base_url = 'https://paidepk.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/paidepk.ee/files';
$settings['file_private_path'] = 'sites/paidepk.ee/privatefiles';
$settings['file_temp_path'] = 'sites/paidepk.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'paidepk_ee_db',
  'username' => 'paidepk_ee_user',
  'password' => 'ik9PYaJ01qEhhnaTQW/IgUXHAqaZXinm',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
