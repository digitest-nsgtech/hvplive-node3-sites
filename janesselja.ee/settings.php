...
$base_url = 'https://janesselja.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/janesselja.ee/files';
$settings['file_private_path'] = 'sites/janesselja.ee/privatefiles';
$settings['file_temp_path'] = 'sites/janesselja.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'janesselja_ee_db',
  'username' => 'janesselja_ee_user',
  'password' => 'MXnUoIUG2qnp+ImN8E2ndxz4be7/4t57',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
