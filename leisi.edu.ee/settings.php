...
$base_url = 'https://leisi.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/leisi.edu.ee/files';
$settings['file_private_path'] = 'sites/leisi.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/leisi.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'leisi_edu_ee_db',
  'username' => 'leisi_edu_ee_user',
  'password' => 'FRzdx1M7C1GgucwQ7uC0BwSv2WgQNdSM',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
