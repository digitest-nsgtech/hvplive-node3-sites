...
$base_url = 'https://sinimae.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/sinimae.edu.ee/files';
$settings['file_private_path'] = 'sites/sinimae.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/sinimae.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'sinimae_edu_ee_db',
  'username' => 'sinimae_edu_ee_user',
  'password' => 'S4TWchvq7vSCWYw7FOiRsglVvXUsB488',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
