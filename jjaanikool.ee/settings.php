...
$base_url = 'https://jjaanikool.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/jjaanikool.ee/files';
$settings['file_private_path'] = 'sites/jjaanikool.ee/privatefiles';
$settings['file_temp_path'] = 'sites/jjaanikool.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'jjaanikool_ee_db',
  'username' => 'jjaanikool_ee_user',
  'password' => 'fozJ8AaJoqmBmkP7C5+pMDio2nJo4zVw',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
