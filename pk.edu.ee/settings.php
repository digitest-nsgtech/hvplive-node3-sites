...
$base_url = 'https://pk.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/pk.edu.ee/files';
$settings['file_private_path'] = 'sites/pk.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/pk.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'pk_edu_ee_db',
  'username' => 'pk_edu_ee_user',
  'password' => 'rr9vqE3/pFh61iArj4NCnkRU5SyFvOVF',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
