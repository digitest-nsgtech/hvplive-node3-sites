...
$base_url = 'https://puhja.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/puhja.edu.ee/files';
$settings['file_private_path'] = 'sites/puhja.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/puhja.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'puhja_edu_ee_db',
  'username' => 'puhja_edu_ee_user',
  'password' => '1k75VM/JBNlcj5QSnLTHCX0cScF/bwcX',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
