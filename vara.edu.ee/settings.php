...
$base_url = 'https://vara.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/vara.edu.ee/files';
$settings['file_private_path'] = 'sites/vara.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/vara.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'vara_edu_ee_db',
  'username' => 'vara_edu_ee_user',
  'password' => 'VKt0ryIIsLbA51QrowIAH4NYZgR5ha2W',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
