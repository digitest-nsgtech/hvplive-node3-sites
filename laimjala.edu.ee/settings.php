...
$base_url = 'https://laimjala.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/laimjala.edu.ee/files';
$settings['file_private_path'] = 'sites/laimjala.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/laimjala.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'laimjala_edu_ee_db',
  'username' => 'laimjala_edu_ee_user',
  'password' => 'uznGkprn3kQg2xDuFcTyauKBHQpc22Zu',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
