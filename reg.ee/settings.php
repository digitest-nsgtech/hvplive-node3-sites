...
$base_url = 'https://reg.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/reg.ee/files';
$settings['file_private_path'] = 'sites/reg.ee/privatefiles';
$settings['file_temp_path'] = 'sites/reg.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'reg_ee_db',
  'username' => 'reg_ee_user',
  'password' => '9qgorWKCGtNU5RAhT4NR72Ow+pAvulnU',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
