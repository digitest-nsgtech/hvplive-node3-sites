...
$base_url = 'https://muumimaja.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/muumimaja.ee/files';
$settings['file_private_path'] = 'sites/muumimaja.ee/privatefiles';
$settings['file_temp_path'] = 'sites/muumimaja.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'muumimaja_ee_db',
  'username' => 'muumimaja_ee_user',
  'password' => 'aYmgRrVTDUInkqYJPh0MtI3Y+Dv2cj9p',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
