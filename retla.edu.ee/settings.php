...
$base_url = 'https://retla.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/retla.edu.ee/files';
$settings['file_private_path'] = 'sites/retla.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/retla.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'retla_edu_ee_db',
  'username' => 'retla_edu_ee_user',
  'password' => '3BxOeASEbYS+IQApUdAvogbj4oO5b3zG',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
