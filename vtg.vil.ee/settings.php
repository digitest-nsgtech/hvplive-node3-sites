...
$base_url = 'https://vtg.vil.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/vtg.vil.ee/files';
$settings['file_private_path'] = 'sites/vtg.vil.ee/privatefiles';
$settings['file_temp_path'] = 'sites/vtg.vil.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'vtg_vil_ee_db',
  'username' => 'vtg_vil_ee_user',
  'password' => 'uQa5sQ0h6kNEVngUUCWC8ImLPNXYXBhs',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
