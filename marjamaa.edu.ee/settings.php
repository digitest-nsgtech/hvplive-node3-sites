...
$base_url = 'https://marjamaa.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/marjamaa.edu.ee/files';
$settings['file_private_path'] = 'sites/marjamaa.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/marjamaa.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'marjamaa_edu_ee_db',
  'username' => 'marjamaa_edu_ee_user',
  'password' => 'yjROKZ6RL4+4wH+weg5ChxOv5yHGaPqT',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
