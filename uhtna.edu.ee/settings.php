...
$base_url = 'https://uhtna.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/uhtna.edu.ee/files';
$settings['file_private_path'] = 'sites/uhtna.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/uhtna.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'uhtna_edu_ee_db',
  'username' => 'uhtna_edu_ee_user',
  'password' => 'u9erMQgGYqm3SsT3MLDP54891mMAyA+p',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
