...
$base_url = 'https://toripk.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/toripk.ee/files';
$settings['file_private_path'] = 'sites/toripk.ee/privatefiles';
$settings['file_temp_path'] = 'sites/toripk.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'toripk_ee_db',
  'username' => 'toripk_ee_user',
  'password' => 'NiyTDH//kELV1bCEzcoiXDZfa+voHJ5J',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
