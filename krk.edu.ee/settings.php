...
$base_url = 'https://krk.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/krk.edu.ee/files';
$settings['file_private_path'] = 'sites/krk.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/krk.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'krk_edu_ee_db',
  'username' => 'krk_edu_ee_user',
  'password' => 'LyDlTAWMdYFIfZFfO1qLfncLjrHhVHMi',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
