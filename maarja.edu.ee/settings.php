...
$base_url = 'https://maarja.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/maarja.edu.ee/files';
$settings['file_private_path'] = 'sites/maarja.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/maarja.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'maarja_edu_ee_db',
  'username' => 'maarja_edu_ee_user',
  'password' => 'YqpoJC5mVLSUlu9aU+lBUCrqPUOhkSLp',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
