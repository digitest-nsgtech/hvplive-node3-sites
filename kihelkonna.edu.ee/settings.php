...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.kihelkonna\.edu\.ee$',
  '^kihelkonna\.edu\.ee$',
];

$base_url = 'https://kihelkonna.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/kihelkonna.edu.ee/files';
$settings['file_private_path'] = 'sites/kihelkonna.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/kihelkonna.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'kihelkonna_edu_ee_db',
  'username' => 'kihelkonna_edu_ee_user',
  'password' => 'P5QOEyE/r4kJZVmTMG0F08oTe5M1ZKfL',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
