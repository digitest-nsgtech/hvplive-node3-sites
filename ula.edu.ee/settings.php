...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.ula\.edu\.ee$',
  '^vaatamisulaeks\.edu\.ee$',
];

$base_url = 'https://ula.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/ula.edu.ee/files';
$settings['file_private_path'] = 'sites/ula.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/ula.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'ula_edu_ee_db',
  'username' => 'ula_edu_ee_user',
  'password' => 'DV44qvHJnVQt+1y2dfoiXsnmMKIGds3+',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
