...
$base_url = 'https://mehaanikakool.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/mehaanikakool.ee/files';
$settings['file_private_path'] = 'sites/mehaanikakool.ee/privatefiles';
$settings['file_temp_path'] = 'sites/mehaanikakool.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'mehaanikakool_ee_db',
  'username' => 'mehaanikakool_ee_user',
  'password' => 'TaYtGu+4acU6Fi76vO+ofg63bhANDza6',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
