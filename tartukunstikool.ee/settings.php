...
$base_url = 'https://tartukunstikool.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/tartukunstikool.ee/files';
$settings['file_private_path'] = 'sites/tartukunstikool.ee/privatefiles';
$settings['file_temp_path'] = 'sites/tartukunstikool.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'tartukunstikool_ee_db',
  'username' => 'tartukunstikool_ee_user',
  'password' => 'KaRxOiBMR4cNlvtI1OmncYvcox9xb6a7',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
