...
$base_url = 'https://poide.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/poide.edu.ee/files';
$settings['file_private_path'] = 'sites/poide.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/poide.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'poide_edu_ee_db',
  'username' => 'poide_edu_ee_user',
  'password' => 'y1udxxPvhN7epZj5TsB6+xxDdsNPguPB',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
