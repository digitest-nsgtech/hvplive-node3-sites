...
$base_url = 'https://saugakool.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/saugakool.ee/files';
$settings['file_private_path'] = 'sites/saugakool.ee/privatefiles';
$settings['file_temp_path'] = 'sites/saugakool.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'saugakool_ee_db',
  'username' => 'saugakool_ee_user',
  'password' => 'RZd7FX1r5Ecn7/hw0ywOgd5tm2GFFlFA',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
