...
$base_url = 'https://kose.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/kose.edu.ee/files';
$settings['file_private_path'] = 'sites/kose.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/kose.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'kose_edu_ee_db',
  'username' => 'kose_edu_ee_user',
  'password' => 'x+yJVLppWiPeDOJY1KdbMsuBZbN8r17l',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
