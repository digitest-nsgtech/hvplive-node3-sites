...
$base_url = 'https://torilasteaed.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/torilasteaed.ee/files';
$settings['file_private_path'] = 'sites/torilasteaed.ee/privatefiles';
$settings['file_temp_path'] = 'sites/torilasteaed.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'torilasteaed_ee_db',
  'username' => 'torilasteaed_ee_user',
  'password' => '6M9ioyq5tFrOP91r8fy9jr8OLPtHqdL1',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
