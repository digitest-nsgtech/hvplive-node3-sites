...
$base_url = 'https://poltsamaa.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/poltsamaa.edu.ee/files';
$settings['file_private_path'] = 'sites/poltsamaa.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/poltsamaa.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'poltsamaa_edu_ee_db',
  'username' => 'poltsamaa_edu_ee_user',
  'password' => '9RfzW3FIZE8gqtxxbxph7YJoP/Rs//+w',
  'prefix' => '',
  'host' => '10.0.4.8',
  'port' => '3306',
